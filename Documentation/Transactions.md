...
This file contains three separate transactions to perform specific operations in a database. As well as a high level layout of error handling for when they are implemented in some kind
of software.
